...
public class DAOEstudiante extends Conexion{
    ...
    public void createEstudiante(Estudiante estudiante){
        ...
        String createSQL = "INSERT INTO estudiante (tipo,documento,nombre,apellido,valorMatricula) VALUES (?,?,?,?,?)";

        try{
            PreparedStatement preparedStatement = connection.prepareStatement(createSQL);
            preparedStatement.setString(1,estudiante1.getTipo());
            preparedStatement.setString(2,estudiante1.getDocumento());
            preparedStatement.setString(3,estudiante1.getNombre());
            preparedStatement.setString(4,estudiante1.getApellido());
            preparedStatement.setDouble(5,estudiante1.getValorMatricula());
    ...
    public ArrayList readAllEstudiante() {
        ...
        String selectAllSQL = "SELECT tipo,documento,nombre,apellido,valorMatricula FROM estudiante";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                estudiante1.setTipo(rs.getString(1));
                estudiante1.setDocumento(rs.getString(2));
                estudiante1.setNombre(rs.getString(3));
                estudiante1.setApellido(rs.getString(4));
                estudiante1.setValorMatricula(rs.getInt(5));
    ...
    public Estudiante readEstudianteByDocumento(String documentoE){
        ...
        String createSQL = "SELECT tipo,documento,nombre,apellido,valorMatricula FROM estudiante WHERE documento ='"+documento1+"'";
        try{
            Statement s = connection.createStatement();
    ...
    public void updateEstudiante(Estudiante estudiante, String documentoE){
        ...
        String tipo=estudiante1.getTipo();
        ...
        String createSQL2 = "UPDATE estudiante SET tipo='"+tipo+"',documento='"+documento+"',nombre='"+nombre+"',apellido='"+apellido+"',valorMatricula='"+valorMatricula+"' WHERE id_estudiante ='"+id_estudiante+"'";
